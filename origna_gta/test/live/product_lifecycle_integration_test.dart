  ...
  group('Product Lifecycle Integration', () {
    ...
    test(
      ...
      () async {
        ...
        expect(
          createdProductId,
          isNotEmpty,
          reason: 'Should return a product ID',
        );
        ...
        expect(
          ...
          equals(ProductLifecycleStatusValues.draft),
        );
      },
    ...
    test(
      ...
      () async {
        expect(
          createdProductId,
          isNotEmpty,
          reason: 'Product must be created first',
        );
    ...
    test(
      ...
      () async {
        ...
        expect(
          doc?.data[Fields.lifecycleStatus],
          equals(ProductLifecycleStatusValues.paused),
        );
      },
      timeout: const Timeout(Duration(minutes: 2)),
    );
