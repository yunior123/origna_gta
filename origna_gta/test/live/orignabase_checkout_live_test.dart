...
void main() {
  ...
  group(
    'OrignaBase Checkout Live Tests',
    ...
    () {
      ...
      test(
        ...
        () async {
          ...
          try {
            ...
            expect(hasUrl || hasSessionId, isTrue,
      ...
      test(
        ...
        () async {
          ...
          expect(doc?.data[Fields.lifecycleStatus],
      ...
      test(
        ...
        () async {
          ...
          try {
            final result =
                await ob.request('POST', ApiEndpoints.couponsApply, body: {
            ...
            expect(
              ...
              isTrue,
              reason: 'Invalid coupon should return 400/404/422, got ${e.statusCode}',
            );
          }
        },
        timeout: const Timeout(Duration(minutes: 2)),
