  ...
  group('WarehousesViewModel live integration', () {
    ...
    test('should create a new warehouse', () async {
      ...
      final viewModelNotifier = container.read(
        warehousesViewModelProvider.notifier,
      );

      final newLabel =
          'Test Warehouse ${DateTime.now().millisecondsSinceEpoch}';
      ...
      try {
        ...
        expect(
          ...
          isTrue,
          reason:
              'Warehouse creation should succeed or surface a live env error',
        );
      } catch (e) {
        expect(
    ...
    test('should update warehouse label', () async {
      if (!runLive) return;
      ...
      final label =
          'Warehouse To Update ${DateTime.now().millisecondsSinceEpoch}';
      try {
        await viewModelNotifier.createWarehouse(
          label: label,
          type: 'standard',
        ...
        if (warehousesSnapshot.docs.isNotEmpty) {
          ...
          expect(
            ...
            isTrue,
            reason:
                'Warehouse update should succeed or surface a live env error',
          );
        }
      } catch (e) {
