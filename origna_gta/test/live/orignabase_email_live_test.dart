...
void main() {
  ...
  group('OrignaBase Email & External Services Live Tests', () {
      ...
      () async {
        try {
          ...
          expect(
            ...
            isNot(equals(500)),
            reason:
                'Password reset should not return 500, got ${e.statusCode}: ${e.message}',
          );
        }
      },
      ...
      () async {
        ...
        try {
          ...
          expect(
            ...
            isNot(equals(500)),
            reason:
                'Email verification should not return 500, got ${e.statusCode}: ${e.message}',
          );
        }
      },
      timeout: const Timeout(Duration(minutes: 2)),
      ...
      () async {
        ...
        try {
          ...
          expect(
            ...
            isTrue,
            reason:
                'Support chat should return a response. Keys: ${result.keys.toList()}',
          );
        } on OrignaBaseException catch (e) {
          ...
          expect(
            ...
            isTrue,
            reason:
                'Support chat failure should be expected error, got ${e.statusCode}: ${e.message}',
          );
        }
      },
      timeout: const Timeout(Duration(minutes: 2)),
      ...
      () async {
        ...
        try {
          final result = await ob.request(
            ...
            body: {
              ...
              'conversation': [
                ...
                {
                  'role': 'assistant',
                  'content': 'I am escalating this to a human agent.',
                },
              ],
            },
          );
          ...
          expect(
            ...
            isTrue,
            reason:
                'Escalation failure should be expected error, got ${e.statusCode}',
          );
        }
      },
      timeout: const Timeout(Duration(minutes: 2)),
      ...
      () async {
        ...
        try {
          final result = await ob.request(
            ...
            body: {'query': '123 Queen St Toronto', 'country': 'CA'},
          );
