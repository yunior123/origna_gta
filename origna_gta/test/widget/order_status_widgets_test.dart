  ...
  group('EmptyOrdersCard', () {
    testWidgets('renders without filter', (tester) async {
      await tester.pumpWidget(
        const MaterialApp(home: Scaffold(body: EmptyOrdersCard())),
      );
  ...
  group('InfoChip', () {
    testWidgets('renders icon and label', (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            body: InfoChip(icon: Icons.shopping_bag, label: '3 items'),
          ),
        ),
      );
  ...
  group('StatusBadge', () {
    ...
    testWidgets('large variant', (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            body: StatusBadge(status: OrderStatus.delivered, large: true),
          ),
        ),
      );
      await tester.pump();
