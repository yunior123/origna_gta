  ...
  group('SellerRegistrationViewModel Unit Tests', () {
    ...
    test('setPaymentProvider updates state and calls backend', () async {
      final viewModel = container.read(
        sellerRegistrationViewModelProvider.notifier,
      );

      await viewModel.setPaymentProvider(PaymentProviderValues.stripe);

      expect(
        container.read(sellerRegistrationViewModelProvider).paymentProvider,
    ...
    test('refreshAccountStatus clears loading for inactive account', () async {
      final viewModel = container.read(
        sellerRegistrationViewModelProvider.notifier,
      );
