...
// in origna_gta/test/unit/notification_repository_test.dart.
...
///
/// See the documentation for Mockito's code generation for more information.
class MockWriteBatch extends _i1.Mock implements _i14.WriteBatch {
  @override
  int get length =>
      (super.noSuchMethod(
  ...
  void create(String? collection, Map<String, dynamic>? data) =>
      super.noSuchMethod(
        Invocation.method(#create, [collection, data]),
        returnValueForMissingStub: null,
      );
  ...
  void update(String? collection, String? id, Map<String, dynamic>? data) =>
      super.noSuchMethod(
        Invocation.method(#update, [collection, id, data]),
        returnValueForMissingStub: null,
      );

  @override
  void delete(String? collection, String? id) => super.noSuchMethod(
    Invocation.method(#delete, [collection, id]),
    returnValueForMissingStub: null,
  );

  @override
  _i20.Future<List<Map<String, dynamic>>> commit() =>
      (super.noSuchMethod(
