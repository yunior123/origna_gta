...
void main() {
  ...
  group('OrderModel', () {
    ...
    test('toMap roundtrip', () {
      ...
      expect(map[Fields.confirmedAt], isA<DateTime>());
  ...
  group('SellerPayout', () {
    ...
    test('toMap includes payoutDate when present', () {
      ...
      final map = payout.toMap();
      expect(map[Fields.payoutDate], isA<DateTime>());
    });
  ...
  group('UserModel extended', () {
    ...
    test('toMap includes seller-specific optional fields', () {
      ...
      expect(map[Fields.lastCheckoutTimestamp], isA<DateTime>());
      expect(map[Fields.suspendedAt], isA<DateTime>());
    });
  ...
  group('ProductModel extended', () {
    ...
    test('toMap includes all fields', () {
      ...
      expect(map[Fields.lifecycleStatus], 'active');
      expect(map[Fields.deletedAt], isA<DateTime>());
    });
