...
void main() {
  group('Shipping Calculation Logic', () {
    ...
    test('calculateTieredShipping handles volumetric weight', () {
      ...
      final bulkyItem = createMockItem(
        weightKg: 1.0,
        lengthCm: 50,
        widthCm: 50,
        heightCm: 50,
    ...
    test('calculateTieredShipping applies speed multipliers', () {
      ...
      final standardCost = calculateTieredShipping(10.0, [
        item,
      ], DeliverySpeed.standard);
      final expressCost = calculateTieredShipping(10.0, [
        item,
      ], DeliverySpeed.express);
      final sameDayCost = calculateTieredShipping(10.0, [
        item,
    ...
    test('fallback shipping uses regional rates', () {
      ...
      // Same province: 12.99
      final sameProv = calculateFallbackShipping(
        items,
    ...
    test(
      'calculateTieredShipping applies speed multipliers correctly even with surcharges',
      () {
