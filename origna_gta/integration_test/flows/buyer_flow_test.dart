  ...
  testWidgets(
    ...
    (tester) async {
      ...
      if (await openSettings(tester)) {
        ...
        if (buyerAddress.evaluate().isNotEmpty) {
          ...
          if (addAddressButton.evaluate().isNotEmpty) {
            ...
            if (streetField.evaluate().isEmpty) {
              throw TestFailure(
                '❌ Add/Edit address screen missing street field',
              );
            }
            ...
            if (!tapped) {
              throw TestFailure(
                '❌ Geoapify suggestions not found for "$searchAddress"',
              );
            }
        ...
        final homeAfterProfile = await ensureHomeReady(
          tester,
          timeoutSeconds: 10,
        );
