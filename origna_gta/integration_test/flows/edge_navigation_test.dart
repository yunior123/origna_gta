...
void main() {
  ...
  testWidgets(
    'Edge Navigation Flow — deep links, error states, and role switching',
    (tester) async {
      debugPrint(
        '🚀🚀🚀 ========== EDGE NAVIGATION TEST START ========== 🚀🚀🚀',
      );
      ...
      if (viewAllCats.evaluate().isNotEmpty) {
        ...
        tracker.check(
          'C104',
          find.text('All Categories').evaluate().isNotEmpty,
          'All categories screen loaded',
        );
      ...
      if (searchIcon.evaluate().isNotEmpty) {
        ...
        tracker.check(
          'C106',
          find.textContaining('No products found').evaluate().isNotEmpty ||
              find.textContaining('0 results').evaluate().isNotEmpty,
