...
final adminActionsViewModelProvider =
    StateNotifierProvider.autoDispose<AdminActionsViewModel, AdminActionsState>(
      (ref) {
...
class AdminActionsViewModel extends StateNotifier<AdminActionsState> {
  ...
  AdminActionsViewModel(this._ref) : super(const AdminActionsState());
  ...
  Future<bool> approveProduct(String productId) async {
    ...
    try {
      ...
      state = state.copyWith(
        isLoading: false,
        errorMessage: AppError.getMessage(e, 'Failed to approve product'),
      );
      return false;
    }
  }
  ...
  Future<bool> rejectProduct(String productId, String reason) async {
    ...
    try {
      ...
      state = state.copyWith(
        isLoading: false,
        errorMessage: AppError.getMessage(e, 'Failed to reject product'),
      );
      return false;
    }
  }
    ...
    try {
      ...
      state = state.copyWith(
        ...
        errorMessage: AppError.getMessage(
          e,
          'admin.errors.delete_product_failed'.tr(),
        ),
      );
      return false;
    }
  ...
  Future<bool> disableAdminMfa(String code) async {
    ...
    try {
      ...
      state = state.copyWith(
        ...
        errorMessage: AppError.getMessage(
          e,
          'admin.errors.mfa_disable_failed'.tr(),
        ),
      );
      return false;
    }
  ...
  Future<Map<String, dynamic>?> enableAdminMfa() async {
    ...
    try {
      ...
      state = state.copyWith(
        ...
        errorMessage: AppError.getMessage(
          e,
          'admin.errors.mfa_enable_failed'.tr(),
        ),
      );
      return null;
    }
  ...
  Future<bool> setUserSuspended(String userId, bool suspended) async {
    ...
    try {
      ...
      state = state.copyWith(
        ...
        errorMessage: AppError.getMessage(
          e,
          'admin.errors.user_suspension_failed'.tr(),
        ),
      );
      return false;
    }
  ...
  Future<bool> updateProductStock(String productId, int quantity) async {
    ...
    try {
      ...
      state = state.copyWith(
        ...
        errorMessage: AppError.getMessage(
          e,
          'admin.errors.update_stock_failed'.tr(),
        ),
      );
      return false;
    }
  ...
  Future<bool> updateUserRoles(
    ...
    try {
      ...
      state = state.copyWith(
        ...
        errorMessage: AppError.getMessage(
          e,
          'admin.errors.user_roles_failed'.tr(),
        ),
      );
      return false;
    }
  ...
  Future<bool> verifyAdminMfa(String code) async {
    ...
    try {
      ...
      state = state.copyWith(
        ...
        errorMessage: AppError.getMessage(
          e,
          'admin.errors.mfa_verify_failed'.tr(),
        ),
      );
      return false;
    }
