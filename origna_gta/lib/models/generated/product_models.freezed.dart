...
// Flat supplier fields (used when supplier object is not provided)
 ...
 String? get sellerSku; List<String>? get warehouseIds; Map<String, int>? get warehouseStock; String? get shipFromCity; String? get shipFromProvince; String? get shipFromCountry; List<String>? get shipFromCountries;// === N-09: Product Variants ===
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,name,price,compareAtPrice,description,const DeepCollectionEquality().hash(imageUrls),sellerId,sellerAddress,categoryId,stockQuantity,rating,isActive,weightKg,lengthCm,widthCm,heightCm,isLocalDeliveryOnly,isPerishable,estimatedShipDays,const DeepCollectionEquality().hash(deliveryOptions),minimumOrderQuantity,freeShipping,isDigital,digitalType,slug,const DeepCollectionEquality().hash(digitalBuilds),deviceLimit,taxCode,const DeepCollectionEquality().hash(keywords),cost,supplierSku,supplierUrl,supplier,inventory,status,sellerSku,const DeepCollectionEquality().hash(warehouseIds),const DeepCollectionEquality().hash(warehouseStock),shipFromCity,shipFromProvince,shipFromCountry,const DeepCollectionEquality().hash(shipFromCountries),hasVariants,const DeepCollectionEquality().hash(variants),const DeepCollectionEquality().hash(variantOptions),subcategory]);
