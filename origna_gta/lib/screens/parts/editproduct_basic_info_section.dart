...
extension _EditProductBasicInfo on _EditProductScreenState {
  Widget buildBasicInfoSection(
    ...
    final hasValidCategory = productCategories.any(
      (category) => category.categoryId.toString() == _categoryController.text,
    );
    ...
    return Column(
      ...
      children: [
        ...
        DropdownButtonFormField<String>(
          ...
          initialValue: hasValidCategory && _categoryController.text.isNotEmpty
