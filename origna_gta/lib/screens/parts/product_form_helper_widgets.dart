...
class _AddVariantOptionButton extends StatelessWidget {
  ...
  void _showAddDialog(BuildContext context) {
    final available = _presets.keys
        .where((k) => !existingNames.contains(k))
        .toList();
        ...
        actions: [
          ...
          FilledButton(
            onPressed: () {
              ...
              final newValues = valuesCtrl.text
                  .split(',')
                  .map((e) => e.trim())
                  .where((e) => e.isNotEmpty)
                  .toList();
...
class _VariantRow extends StatelessWidget {
  ...
  static InputDecoration _variantFieldDecoration(
    String label, {
    String? prefixText,
  }) {
    return InputDecoration(
      ...
      enabledBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(10),
        borderSide: BorderSide(
          color: DesignTokens.outline.withValues(alpha: 0.25),
        ),
      ),
