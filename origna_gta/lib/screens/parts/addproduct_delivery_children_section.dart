              ...
              children: [
                Expanded(
                  child: buildGlassTextField(
                    ...
                    semanticsLabel: 'input-standard-days',
                  ),
                ),
                ...
                Expanded(
                  child: buildGlassTextField(
                    ...
                    semanticsLabel: 'input-standard-price',
                  ),
                ),
              ],
            ),
                ...
                children: [
                  Expanded(
                    child: buildGlassTextField(
                      ...
                      hint: 'product.est_business_days_hint'.tr(),
                      keyboardType: TextInputType.number,
                      semanticsLabel: 'input-express-days',
                    ),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                    child: buildGlassTextField(
                      ...
                      label: 'product.price_dollar'.tr(),
                      keyboardType: TextInputType.number,
                      semanticsLabel: 'input-express-price',
                    ),
                  ),
                ],
              ),
