...
class _ProductDetailScreenState extends ConsumerState<ProductDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final rawInitialProduct = widget.product;
    if (rawInitialProduct != null) {
      try {
        initialProduct = Product.fromJson(rawInitialProduct);
      } catch (_) {
        initialProduct = null;
      }
    }
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    left: 0,
                    right: 0,
                    child: _ImageDots(imageCount: totalMediaCount),
                  ),
                ],
              ),
            );
...
String _localizedDeliveryEstimate(Product product) {
  final deliveryInfo = product.deliveryInfo;
...
String _localizedShipsFrom(Product product) {
      ...
      child: Column(
        ...
        children: [
          ...
          _DeliveryInfoRow(
            ...
            value: _localizedDeliveryEstimate(product),
            isDark: isDark,
          ),
          ...
          if (deliveryInfo.supplierRegion != null) ...[
            _DeliveryInfoRow(
              ...
              value: _localizedShipsFrom(product),
              isDark: isDark,
...
class _SellerInfoCard extends ConsumerWidget {
  final Product product;
