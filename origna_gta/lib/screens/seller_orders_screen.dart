    ...
    return Container(
      ...
      child: Scaffold(
        ...
        body: ordersAsync.when(
          ...
          error: (error, _) =>
              AnimatedEmptyState(icon: Icons.error_outline_rounded, title: 'seller.something_wrong'.tr(), subtitle: 'seller.could_not_load'.tr()),
          data: (orders) {
            if (orders.isEmpty) {
              ...
              onPressed: () {
                ...
                if (tracking.isNotEmpty) {
                  ...
                  ref
                      ...
                      .updateItemStatus(order.orderId, item.productId, DeliveryStatusValues.shipped, trackingNumber: tracking);
                }
              },
              height: 42,
            ),
