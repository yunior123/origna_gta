                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              ...
                              BoxShadow(
                                color: DesignTokens.gradientStart.withValues(
                                  alpha: 0.35,
                                ),
                                blurRadius: 24,
                                    ...
                                    Expanded(
                                      child: RichText(
                                        text: TextSpan(
                                          ...
                                          children: [
                                            TextSpan(
                                              text: 'auth.agree_to_prefix'.tr(),
                                            ),
                                            TextSpan(
                                              text: 'auth.terms_conditions'
                                                  .tr(),
                                            ...
                                            TextSpan(
                                              text: 'auth.and_conjunction'.tr(),
                                            ),
                                            TextSpan(
                                              text: 'auth.privacy_policy_link'
                                                  .tr(),
                                              style: const TextStyle(
                                                color: DesignTokens.primary,
                                                fontWeight: FontWeight.w600,
