...
final _previewCommonEmailVerificationUser = AppAuthUser(
  uid: 'preview-common-email-verification-user',
  email: 'verify.me@origna.ca',
  emailVerified: false,
);

Widget _emailVerificationPreview() => previewScope(
  extraOverrides: [
    currentUserProvider.overrideWith(
      (ref) => _previewCommonEmailVerificationUser,
    ),
  ],
