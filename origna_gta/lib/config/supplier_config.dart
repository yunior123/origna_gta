...
//
// IMPORTANT: CANADA-ONLY MARKETPLACE
...
// - Sellers must convert their costs mentally/externally when tracking margins
// - Products are always priced and sold in CAD to Canadian customers
...
final Map<String, SupplierPlatformConfig> supplierPlatforms = {
  ...
  'oberlo': const SupplierPlatformConfig(
    id: 'oberlo',
    displayName: 'Oberlo',
    region: 'Global',
    country: 'Various',
