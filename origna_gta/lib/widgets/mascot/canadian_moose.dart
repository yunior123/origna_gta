...
class MoosePainter extends CustomPainter {
  ...
  void _drawEyes(Canvas canvas, Size size) {
    ...
    if (blinkValue > 0.1) {
      final blinkPaint = Paint()..color = const Color(0xFF3E2723)..style = PaintingStyle.stroke..strokeWidth = 2.5..strokeCap = StrokeCap.round;
    ...
    // Blush
    final blushPaint = Paint()..color = Colors.red.withValues(alpha: 0.15)..maskFilter = const MaskFilter.blur(BlurStyle.normal, 3);
  ...
  void _drawNostrils(Canvas canvas, Size size) {
    ...
    final mouthPaint = Paint()..color = const Color(0xFF4E342E)..style = PaintingStyle.stroke..strokeWidth = 1.5..strokeCap = StrokeCap.round;
