...
List<Route<dynamic>> _onGenerateInitialRoutes(String initialRoute) {
  ...
  if (uri != null && uri.path == '/payment-success') {
    ...
    return [MaterialPageRoute(builder: (_) => const AuthWrapper()), MaterialPageRoute(builder: (_) => const ErrorScreen(message: 'Invalid payment link'))];
  }
  ...
  if (uri != null && uri.path == '/payment-cancel') {
    return [
      MaterialPageRoute(builder: (_) => const AuthWrapper()),
      MaterialPageRoute(builder: (_) => const AuthRequiredGate(child: PaymentCanceledScreen())),
    ];
  }
...
Route<dynamic>? _onGenerateRoute(RouteSettings settings) {
  ...
  if (uri.path == '/payment-success') {
    ...
    if (sessionId == null || sessionId.isEmpty) {
      return MaterialPageRoute(builder: (_) => const ErrorScreen(message: 'Invalid payment link'));
    }
