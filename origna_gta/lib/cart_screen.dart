        ...
        child: ConstrainedBox(
          ...
          child: cartItemsAsync.when(
            ...
            data: (cartItems) {
              ...
              // Extract just the product IDs - this list only changes when items are added/removed
...
class _CartItemWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Watch only this item's quantity - changes when +/- is tapped
    final quantity = ref.watch(cartItemQuantityProvider(productId));
    ...
    return itemAsync.when(
      ...
      data: (item) {
        ...
        // Update with current quantity from the reactive provider
