...
pub struct NotificationsState {
    ...
    pub fcm_REDACTED_SECRET: Option<String>,
...
impl NotificationsState {
    ...
    pub fn new(
        ...
        fcm_REDACTED_SECRET: Option<String>,
...
async fn send_notification(
    ...
    if let (Some(project_id), Some(_REDACTED_SECRET)) =
        (&state.fcm_project_id, &state.fcm_REDACTED_SECRET)
    {
...
mod tests {
    ...
    fn test_notifications_state_new() {
        ...
        fn _assert_constructor_types(
            ...
            let _state = NotificationsState::new(db, project_id, REDACTED_SECRET, http);
        }
    }
    ...
    #[tokio::test]
    async fn test_notifications_state_get_fcm_token_no_REDACTED_SECRET() {
        let state = test_state().await;
