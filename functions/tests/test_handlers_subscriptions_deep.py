...
class TestSubscriptionHelpersDeep:
    ...
    @patch("handlers.subscriptions.get_stripe_secret_key", return_value="STRIPE_SECRET_KEY_REDACTED")
    def test_stripe_init_caches_secret(self, mock_key):
        ...
        subscriptions._stripe_init()
        assert subscriptions.stripe.api_key == "STRIPE_SECRET_KEY_REDACTED"
