...
def get_order_confirmation_email(order_data, order_id=None):
    ...
    <body style="margin: 0; padding: 0; background-color: #f0f2f8; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; -webkit-font-smoothing: antialiased;">
        ...
        <tr><td bgcolor="#1a1a2e" style="background-color: #1a1a2e; padding: 32px 40px; text-align: center;">
            ...
            <p style="margin: 0 0 8px 0; font-size: 13px; color: rgba(255,255,255,0.5);">Canada's Modern Marketplace</p>
            <p style="margin: 0 0 16px 0; font-size: 12px; color: rgba(255,255,255,0.35);">Questions? Reach us at <a href="mailto:support@orignaventures.ca" style="color: #667EEA; text-decoration: none;">support@orignaventures.ca</a></p>
...
def get_seller_notification_email(order_data, order_id=None, seller_id=None):
    ...
    <body style="margin: 0; padding: 0; background-color: #f0f2f8; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; -webkit-font-smoothing: antialiased;">
        ...
        <tr><td bgcolor="#1a1a2e" style="background-color: #1a1a2e; padding: 32px 40px; text-align: center;">
            ...
            <p style="margin: 0 0 16px 0; font-size: 12px; color: rgba(255,255,255,0.35);">Questions? <a href="mailto:support@orignaventures.ca" style="color: #667EEA; text-decoration: none;">support@orignaventures.ca</a></p>
            <div style="border-top: 1px solid rgba(255,255,255,0.1); padding-top: 16px;">
                <p style="margin: 0; font-size: 11px; color: rgba(255,255,255,0.25);">© 2026 Origna Ventures Inc. All rights reserved.</p>
            </div>
        </td></tr>
...
def send_email(to_email, subject, html_content, from_email="support@orignaventures.ca"):
...
def send_authorization_expired_email(order_id: str, order_data: dict) -> None:
    ...
    try:
        ...
        buyer_message = {
            'Messages': [{
                'From': {'Email': 'support@orignaventures.ca', 'Name': 'Origna GTA'},
...
def send_payment_capture_failed_email(order_id: str, customer_email: str, customer_name: str, amount: float, error_message: str):
    ...
    <body style="margin: 0; padding: 0; background-color: #f0f2f8; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">
        ...
        <tr><td bgcolor="#1a1a2e" style="background-color: #1a1a2e; padding: 28px 40px; text-align: center;">
            ...
            <p style="margin: 0 0 12px 0; font-size: 12px; color: #5c5c72;">Questions? <a href="mailto:support@orignaventures.ca" style="color: #667EEA; text-decoration: none;">support@orignaventures.ca</a></p>
    ...
    try:
        result = mailjet.send.create(data={
            'Messages': [{
                'From': {'Email': 'support@orignaventures.ca', 'Name': 'OrignaGTA'},
...
def send_3ds_authentication_email(order_id: str, customer_email: str, customer_name: str, authentication_url: str, amount: float):
    ...
    <body style="margin: 0; padding: 0; background-color: #f0f2f8; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">
        ...
        <tr><td bgcolor="#1a1a2e" style="background-color: #1a1a2e; padding: 28px 40px; text-align: center;">
            ...
            <p style="margin: 0 0 8px 0; font-size: 12px; color: #5c5c72;">Questions? <a href="mailto:support@orignaventures.ca" style="color: #667EEA; text-decoration: none;">support@orignaventures.ca</a></p>
    ...
    result = mailjet.send.create(data={
        'Messages': [{
            'From': {'Email': 'support@orignaventures.ca', 'Name': 'OrignaGTA Security'},
            'To': [{'Email': customer_email, 'Name': customer_name}],
            'Subject': subject,
            'HTMLPart': html_body,
        }]
