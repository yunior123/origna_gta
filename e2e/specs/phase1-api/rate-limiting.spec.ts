...
describe('Rate Limiting', () => {
  // timeout: 120_000 — 10 parallel checkout requests + rate limit check can exceed 60s under dev load
  ...
  test('Rapid checkout requests trigger rate limiting', { timeout: 120_000 }, async () => {
  ...
  test('Multiple rapid API calls do not crash the service', { timeout: 120_000 }, async () => {
