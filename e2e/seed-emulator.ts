...
const PRODUCTS: SeedProduct[] = [
  ...
  { name: 'Ottawa Parliament Puzzle 1000pc', price: 39.99, description: '1000-piece jigsaw puzzle featuring the Parliament Buildings during autumn. Made in Canada.', categoryId: 6, stockQuantity: 35, sellerIndex: 4, imageUrls: ['https://picsum.photos/seed/puzzle/400/400'], keywords: ['puzzle', 'ottawa', 'parliament', 'jigsaw', 'toy', 'game'], freeShipping: false, isDigital: false, isLocalDeliveryOnly: false, isPerishable: false, estimatedShipDays: 3, weightKg: 0.8, deliveryOptions: [{ speed: 'standard', isEnabled: true, estimatedDays: 5, price: 0 }] },
  { name: 'Organic Maple Syrup (1L)', price: 22.50, description: 'Grade A amber organic maple syrup from Eastern Ontario sugar bush. 100% pure.', categoryId: 19, stockQuantity: 80, sellerIndex: 4, imageUrls: ['https://picsum.photos/seed/maple/400/400'], keywords: ['maple', 'syrup', 'organic', 'ontario', 'food', 'canadian'], freeShipping: false, isDigital: false, isLocalDeliveryOnly: false, isPerishable: false, estimatedShipDays: 3, weightKg: 1.1, deliveryOptions: [{ speed: 'standard', isEnabled: true, estimatedDays: 5, price: 0 }, { speed: 'express', isEnabled: true, estimatedDays: 2, price: 11.99 }] },
  
  // Combo sellers (indices 21-24 in USERS array)
  { name: 'Quebec Pottery Mug Set (4)', price: 59.99, description: 'Set of 4 hand-thrown ceramic mugs from a Quebec artisan workshop. Dishwasher safe.', categoryId: 3, stockQuantity: 15, sellerIndex: 21, imageUrls: ['https://picsum.photos/seed/mugs/400/400'], keywords: ['mug', 'pottery', 'ceramic', 'quebec', 'kitchen', 'handmade'], freeShipping: false, isDigital: false, isLocalDeliveryOnly: false, isPerishable: false, estimatedShipDays: 5, weightKg: 2.0, deliveryOptions: [{ speed: 'standard', isEnabled: true, estimatedDays: 7, price: 0 }] },
