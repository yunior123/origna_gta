...
const PRODUCTS: SeedProduct[] = [
  // ── Seller 1 (QC) ──────────────────
  { id: 'product_001', name: 'Handmade Quebec Scarf', price: 45.99, description: 'Beautiful handwoven scarf made with Quebec alpaca wool.', categoryId: 2, stockQuantity: 25, sellerEmail: 'seller1@test.origna.ca', imageUrls: ['https://picsum.photos/seed/scarf/400/400'], keywords: ['scarf','wool','quebec'], freeShipping: false, isDigital: false, isLocalDeliveryOnly: false, isPerishable: false, estimatedShipDays: 3, weightKg: 0.3, deliveryOptions: [{ speed: 'standard', isEnabled: true, estimatedDays: 5, price: 0 }, { speed: 'express', isEnabled: true, estimatedDays: 2, price: 9.99 }] },
  { id: 'product_002', name: 'Montreal Artisan Leather Bag', price: 189.99, description: 'Premium leather messenger bag crafted in Mile End, Montreal.', categoryId: 2, stockQuantity: 10, sellerEmail: 'seller1@test.origna.ca', imageUrls: ['https://picsum.photos/seed/bag/400/400'], keywords: ['bag','leather','montreal'], freeShipping: true, isDigital: false, isLocalDeliveryOnly: false, isPerishable: false, estimatedShipDays: 3, weightKg: 1.2, deliveryOptions: [{ speed: 'standard', isEnabled: true, estimatedDays: 5, price: 0 }] },
  { id: 'product_003', name: 'Quebec Tourtière Spice Kit', price: 12.99, description: 'Authentic spice blend for traditional Quebec tourtière.', categoryId: 13, stockQuantity: 100, sellerEmail: 'seller1@test.origna.ca', imageUrls: ['https://picsum.photos/seed/spice/400/400'], keywords: ['spice','food','quebec'], freeShipping: false, isDigital: false, isLocalDeliveryOnly: false, isPerishable: false, estimatedShipDays: 4, weightKg: 0.15, deliveryOptions: [{ speed: 'standard', isEnabled: true, estimatedDays: 5, price: 0 }] },

  // ── Seller 2 (BC) ──────────────────
  { id: 'product_004', name: 'BC Cedar Incense Set', price: 24.99, description: 'Hand-harvested BC red cedar incense sticks.', categoryId: 3, stockQuantity: 50, sellerEmail: 'seller2@test.origna.ca', imageUrls: ['https://picsum.photos/seed/incense/400/400'], keywords: ['incense','cedar','bc'], freeShipping: false, isDigital: false, isLocalDeliveryOnly: false, isPerishable: false, estimatedShipDays: 4, weightKg: 0.2, deliveryOptions: [{ speed: 'standard', isEnabled: true, estimatedDays: 5, price: 0 }] },
  { id: 'product_005', name: 'Pacific Coast Trail Running Shoes', price: 129.99, description: 'Lightweight trail runners designed for BC mountains.', categoryId: 4, stockQuantity: 30, sellerEmail: 'seller2@test.origna.ca', imageUrls: ['https://picsum.photos/seed/shoes/400/400'], keywords: ['shoes','running','trail'], freeShipping: false, isDigital: false, isLocalDeliveryOnly: false, isPerishable: false, estimatedShipDays: 3, weightKg: 0.8, deliveryOptions: [{ speed: 'standard', isEnabled: true, estimatedDays: 5, price: 0 }, { speed: 'express', isEnabled: true, estimatedDays: 2, price: 12.99 }] },
